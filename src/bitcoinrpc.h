...
#ifndef _CARPEDIEMCOINRPC_H_
#define _CARPEDIEMCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // carpediemcoin is not connected
...
/**
 * carpediemcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
