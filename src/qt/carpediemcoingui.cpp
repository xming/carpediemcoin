/*
 * Qt4 carpediemcoin GUI.
 *
 * W.J. van der Laan 2011-2012
 * The carpediemcoin Developers 2011-2012
 */
#include "carpediemcoingui.h"
...
carpediemcoinGUI::~carpediemcoinGUI()
{
...
void carpediemcoinGUI::createActions()
{
    ...
    optionsAction->setToolTip(tr("Modify configuration options for carpediemcoin"));
...
void carpediemcoinGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void carpediemcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/carpediemcoin_testnet"));
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("carpediemcoin client") + QString(" ") + tr("[testnet]"));
...
void carpediemcoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void carpediemcoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void carpediemcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void carpediemcoinGUI::optionsClicked()
{
...
void carpediemcoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void carpediemcoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void carpediemcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
void carpediemcoinGUI::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void carpediemcoinGUI::changeEvent(QEvent *e)
{
...
void carpediemcoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void carpediemcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "which goes to the nodes that process your transaction and helps to support the network.  "
          "Do you want to pay the fee?").arg(
                carpediemcoinUnits::formatWithUnit(carpediemcoinUnits::BTC, nFeeRequired));
...
void carpediemcoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(carpediemcoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void carpediemcoinGUI::gotoOverviewPage()
{
...
void carpediemcoinGUI::gotoHistoryPage()
{
...
void carpediemcoinGUI::gotoAddressBookPage()
{
...
void carpediemcoinGUI::gotoReceiveCoinsPage()
{
...
void carpediemcoinGUI::gotoSendCoinsPage()
{
...
void carpediemcoinGUI::gotoSignMessageTab(QString addr)
{
...
void carpediemcoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void carpediemcoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void carpediemcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid carpediemcoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void carpediemcoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void carpediemcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void carpediemcoinGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void carpediemcoinGUI::backupWallet()
{
...
void carpediemcoinGUI::changePassphrase()
{
...
void carpediemcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void carpediemcoinGUI::toggleHidden()
{
