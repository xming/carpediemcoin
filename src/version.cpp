...
// for both carpediemcoind and carpediemcoin-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("carpediemcoin");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-diem"
...
#        define BUILD_DATE "May 11th, 2014"
#    else
